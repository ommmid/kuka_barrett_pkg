...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub3 = nh.advertise<std_msgs::Float64>("/bh_j22_position_controller/command",1000);
  ros::Publisher pub4 = nh.advertise<std_msgs::Float64>("/bh_j32_position_controller/command",1000);
  ros::Publisher pub5 = nh.advertise<trajectory_msgs::JointTrajectory > ("/arm_controller/command", 1000);
  ros::Rate loop_rate(1);

  std_msgs::Float64 msg1;  msg1.data = 1.5f;
  std_msgs::Float64 msg2;  msg2.data = 0.45f;
  std_msgs::Float64 msg3;  msg3.data = 0.85f;
  std_msgs::Float64 msg4;  msg4.data = 1.0f;
